    ...
    <body>
        ...
        <%
            ...
            String sqlInserts[] = new String[]{
                ...
                "INSERT INTO "+schema+".GAME (id,CONSOLE,DESCRIPTION, DISPONIBLE, PRICE, TITLE, STOREADRESS) VALUES (NEXT VALUE FOR Game_Seq,'MegaDrive','Awesome game 1', 1, 59.99, 'Game 1', 'Store 1')",
                "INSERT INTO "+schema+".GAME (id,CONSOLE,DESCRIPTION, DISPONIBLE, PRICE, TITLE, STOREADRESS) VALUES (NEXT VALUE FOR Game_Seq,'GameCube','Exciting adventure', 1, 49.99, 'Game 2', 'Store 2')",
                "INSERT INTO "+schema+".GAME (id,CONSOLE,DESCRIPTION, DISPONIBLE, PRICE, TITLE, STOREADRESS) VALUES (NEXT VALUE FOR Game_Seq,'GameCube','Multiplayer challenge', 0, 29.99, 'Game 3', 'Store 3')",
                "INSERT INTO "+schema+".GAME (id,CONSOLE,DESCRIPTION, DISPONIBLE, PRICE, TITLE, STOREADRESS) VALUES (NEXT VALUE FOR Game_Seq,'GameCube','Sci-fi experience', 1, 54.99, 'Game 4', 'Store 4')",
                "INSERT INTO "+schema+".GAME (id,CONSOLE,DESCRIPTION, DISPONIBLE, PRICE, TITLE, STOREADRESS) VALUES (NEXT VALUE FOR Game_Seq,'Nds','Puzzle-solving fun', 1, 39.99, 'Game 5', 'Store 5')",
